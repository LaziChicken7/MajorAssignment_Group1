...
public class WalletController {
    ...
    @FXML public void handleDeposit(javafx.event.ActionEvent event) { switchView(event, "/com/auction/view/DepositForm.fxml"); }
    @FXML public void handleWithdraw(javafx.event.ActionEvent event) { switchView(event, "/com/auction/view/WithDrawForm.fxml"); }
    @FXML public void handleSuccessfulTransaction(javafx.event.ActionEvent event) { switchView(event, "/com/auction/view/SuccessfulTransaction.fxml"); }
    @FXML public void handleFailureTransaction(javafx.event.ActionEvent event) { switchView(event, "/com/auction/view/FailureTransaction.fxml"); }

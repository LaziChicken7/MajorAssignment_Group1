...
* `auctionsystemdemo/` - frontend JavaFX demo
* `Frontend/auctionsystemdemo/` - mã JavaFX bổ sung
...
## Ghi chú
* Dự án dùng `spring.jpa.hibernate.ddl-auto: none` nên không tự động tạo bảng.

...
import org.auctionfx.auctionbidsystemspringboot.enums.AuctionStatus;
import org.auctionfx.auctionbidsystemspringboot.exception.NotEnoughMoneyException;
import org.auctionfx.auctionbidsystemspringboot.service.PaymentService;
...
public class Auction extends BaseEntity {
    ...
    public boolean placeBid(Bidder bidder, BigDecimal bidAmount, LocalDateTime bidTimestamp) throws NotEnoughMoneyException {
        lock.lock();
        try {
